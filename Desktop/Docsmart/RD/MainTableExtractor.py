...
class MainTableExtractor:
    ...
    def execute(self):
        ...
        header_keywords = [
            ...
            "gst no", "invoice no", "description of goods", "type", "hsn/sac", "gst rate", "rate", 
            "e-way bill no", "product", "hsn","particular","Asseasseble value",
            "particular", "sr.", "assessable value",'sr.',
            "product description", "description of goods /services",
            "description", "product name", "per", "unit", "uqc",
            "hsn/sac code", "hsn code", "hsn/sac", "hsn","grade","material code","uom"
        ]
        ...
        table_region = self.image[min_y+20:max_y, min_x:max_x]  # Removed fixed padding for dynamic table extraction
